// ============================================
// app/api/ai/analyse-crm/route.ts
// GET: dernière prédiction CRM
// POST: déclenche analyserCRM()
// ============================================
import { NextRequest, NextResponse } from 'next/server'
import { createClient } from '@/lib/supabase/server'
import { createClient as createAdminClient } from '@/lib/supabase/admin'
import { getUtilisateur } from '@/lib/supabase/getUtilisateur'
import { analyserCRM } from '@/lib/services/ai/crm'
...
export async function POST(request: NextRequest) {
  ...
  try {
    const result = await analyserCRM(eid)
