-- ============================================
-- supabase/modules/tarifs.sql
-- Données tarifaires dans site_settings
-- À exécuter UNE SEULE FOIS dans Supabase SQL Editor
-- La table site_settings doit déjà exister
-- ============================================

-- Tarifs services individuels
